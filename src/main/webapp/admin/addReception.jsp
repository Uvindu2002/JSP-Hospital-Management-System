	        ...
	        <div class="content-wrapper">
	          <div class="row">
		        <div class="col-10 grid-margin stretch-card">
		              <div class="card">
		                <div class="card-body">
		                  <h4 class="card-title">Add Reception</h4>
		                  
		                  <form class="forms-sample" method="post" action="/HospitalManagement/AddReceptionServelet">
...
<script>
    function validateForm() {
        ...
        // Name validation (maximum 50 characters)
        if (name.length > 50) {
            document.getElementById('nameError').textContent = 'Name should not exceed 50 characters';
            return false;
        }
