      ...
      <%@include file="navBars/sidenavbar.jsp" %>
        ...
        <div class="main-panel">
	        <div class="content-wrapper">
	          ...
	          <form id="form" method="post" action="patients.jsp" class="form-horizontal">
	                    ...
	                    <table class="table">
	                      ...
	                      <tbody>
	                        <tr>
	                          ...
	                          <td>
	                          	<button type="button" class="btn btn-primary btn-rounded btn-fw" onclick="window.location.href='updatePatient.jsp?id=<%=mob%>'">Update</button>	              
	                          	&nbsp;&nbsp;&nbsp;&nbsp;
	                          	<button type="button" class="btn btn-danger btn-rounded btn-fw" onclick="window.location.href='deleteAccounts.jsp?id=<%=mob%>&table=patient'">Delete</button>
	                          </td>
	                        </tr>
