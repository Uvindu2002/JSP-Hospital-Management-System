		              ...
		              <div class="card">
		                <div class="card-body">
		                  ...
		                  <%
					            ...
					            String s = "SELECT * FROM patient WHERE patientId = '"+mob+"' ";
					            PreparedStatement pstmt = con.prepareStatement(s);
					            ResultSet  rs = pstmt.executeQuery();
					            while (rs.next()) {
					        %> 
		                  <form class="forms-sample" method="post" action="/HospitalManagement/UpdatePatientServelet">
		                    ...
		                    <div class="form-group">
		                     ...
		                     <div class="form-group">
		                      ...
		                      <input type="text" class="form-control" value="<%= rs.getString(3)%>" name="nic" placeholder="Name" readonly>
		                    </div>
		                    <div class="form-group">
		                      <label for="exampleInputEmail3">Email</label>
		                      <input type="text" class="form-control" value="<%= rs.getString(4)%>" name="email" placeholder="Email">
		                    </div>
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                      <label for="exampleInputPassword4">Registered Date</label>
		                      <input type="text" class="form-control" value="<%= rs.getString(7)%>" name="joined_date" placeholder="address" readonly>
		                    </div>
